...
class MapTRAssigner(BaseAssigner):
    ...
    def __init__(self,
                 ...
                 pc_range=None):
        self.z_cfg = z_cfg
        self.cls_cost = MAPTR_COST.build(cls_cost)
        self.reg_cost = MAPTR_COST.build(reg_cost)
        self.iou_cost = MAPTR_COST.build(iou_cost)
        self.pts_cost = MAPTR_COST.build(pts_cost)
