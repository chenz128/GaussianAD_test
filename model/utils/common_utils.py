...
def merge_results_dist(result_part, size, tmpdir, eval_output_dir):
    ...
    for res in (part_list):
        for key in ordered_results.keys():
            ordered_results[key].extend(list(res[0][key]))
    # # ordered_results = ordered_results[:size]
    pickle.dump(ordered_results, open(os.path.join(eval_output_dir, 'result_part_total.pkl'), 'wb'))
    # ordered_results = pickle.load(open(os.path.join(eval_output_dir, 'result_part_total.pkl'), 'rb'))
