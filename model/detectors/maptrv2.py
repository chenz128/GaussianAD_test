...
class MapTRv2(MVXTwoStageDetector):
    ...
    def forward_train(self,
        ...
        outs = self.pts_bbox_head(encoded_spconv_tensor)

        # losses = dict()
        # loss_inputs = [gt_bboxes_3d, gt_labels_3d, gt_seg_mask, None, outs]
        # losses_pts = self.pts_bbox_head.loss(*loss_inputs, img_metas=None)
    ...
    def forward(self, batch_dict, return_loss=True):
        ...
        if return_loss:
            return self.forward_train(
                ...
                gt_bboxes_3d=batch_dict['metas']['gt_bboxes_3d'],
                gt_labels_3d=batch_dict['metas']['gt_labels_3d'],
