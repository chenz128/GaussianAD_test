...
if __name__ == '__main__':
    ...
    write_version_to_file(version, 'model/ops/version.py')
    ...
    setup(
        ...
        ext_modules=[
            ...
            make_cuda_ext(
                ...
                module='model.ops.roiaware_pool3d',
                sources=[
            ...
            make_cuda_ext(
                ...
                module='model.ops.roipoint_pool3d',
                sources=[
            ...
            make_cuda_ext(
                ...
                module='model.ops.pointnet2.pointnet2_stack',
                sources=[
            ...
            make_cuda_ext(
                ...
                module='model.ops.pointnet2.pointnet2_batch',
                sources=[
                    'src/pointnet2_api.cpp',
                    'src/ball_query.cpp',
                    'src/ball_query_gpu.cu',
