...
class OccupancyFlowLossV3Isolated(BaseLoss):
    ...
    def loss_voxel(self, inputs, sampled_xyz=None,):
        ...
        return tot_loss * self.weight * flow_weight


    def forward(self, inputs):
        loss = 0
        for single in inputs['occ_flow']:
            loss += self.loss_voxel(single[0])
        return loss * 0.1
