...
SRC_CFG="nuscenes_gs25600_gtbox_oracle_v12_ft_plan_time_aligned_gaussian"
EXP_NAME="nuscenes_gs25600_v12_fixempty_ft_plan_time_aligned_gaussian"
...

{
  ...
  echo "config     : ${CONFIG}"
  echo "init from  : FutAttn epoch 15"
  echo "planner    : single-head time-aligned Gaussian attention"
  echo "loss       : base losses + final cumulative-position weight 0.5"
