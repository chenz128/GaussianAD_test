...
SRC_CFG="nuscenes_gs25600_gtbox_oracle_v12_ft_plan_timequery_residual"
EXP_NAME="nuscenes_gs25600_v12_fixempty_ft_plan_timequery_residual"
REPO="/data/xinyao/navsim_workspace/GaussianAD"
PY="/data/chenz/conda_env/splatting/bin/torchrun"
CONFIG="config/nuscenes_gs25600_gtbox_oracle_v12_ft_plan_time0813/${SRC_CFG}.py"
WORK_DIR="exp/${EXP_NAME}"
GPUS="4,5,6,7"
NPROC=4
MASTER_PORT="${MASTER_PORT:-12488}"
...

{
  ...
  echo "delta      : hybrid time encoding + supervised per-time queries + gated fusion"
