...
loss = dict(
    ...
    loss_cfgs=[
        ...
        dict(
            ...
            sem_lw=5.0,
            depth_lw=0.5,
            vis_dir='out/nuscenes_gs25600_gtbox_oracle_v5/render_vis',
            vis_every=500,
        ),
        dict(
            type='DynamicLoss',
            ...
            vis_dir='out/nuscenes_gs25600_gtbox_oracle_v5/dynamic_vis',
            vis_every=500,
        ),
        dict(
            type='PhysicsLoss',
            ...
            # v5: vel_w 1.0->0.5 to reduce the kinematic (non-occ-aligned)
            # gradient injected into the shared encoder, which inflated train
            # OccLoss (v4=8.36 vs base=6.82) and widened the current-frame mIoU
            # gap. Plan-A selective warmup keeps offset from blowing up.
            vel_w=0.5,
            warmup_epoch=2,
            use_gt_box=True,
            v_thresh=0.5,
