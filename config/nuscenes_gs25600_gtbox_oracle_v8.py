...
loss = dict(
    ...
    loss_cfgs=[
        ...
        dict(
            ...
            sem_lw=5.0,
            depth_lw=0.5,
            vis_dir='out/nuscenes_gs25600_gtbox_oracle_v8/render_vis',
            vis_every=500,
        ),
        dict(
            type='DynamicLoss',
            ...
            vis_dir='out/nuscenes_gs25600_gtbox_oracle_v8/dynamic_vis',
            vis_every=500,
        ),
        dict(
            type='PhysicsLoss',
...
model = dict(
    ...
    temporal_encoder=dict(
        ...
        refine_layer=dict(
            ...
            # stays == v7. The gradient leak is the only current-frame risk and
            # is deferred to v8b (offset_grad_scale=0.05) if v8's offset still
            # fails to move.
