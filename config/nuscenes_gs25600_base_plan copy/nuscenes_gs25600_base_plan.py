...
# base_plan experiment: warm-start from occ+det baseline (epoch 15) and add
# map + plan supervision (occ + flow + det + map + plan, no render), train 15 epochs.
load_from = 'out/nuscenes_gs25600_base/checkpoints/epoch_15.pth'
max_epochs = 15  # fresh cosine schedule over 15 epochs from the base warm-start
