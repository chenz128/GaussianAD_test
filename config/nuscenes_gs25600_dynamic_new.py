"""
nuscenes_gs25600_dynamic_new 实验配置
...
差异于 nuscenes_gs25600_2D.py：
  ...
  - work_dir / vis_dir → out/nuscenes_gs25600_dynamic_new
...
loss = dict(
    ...
    loss_cfgs=[
        ...
        dict(
            ...
            sem_lw=5.0,
            depth_lw=0.5,
            vis_dir='out/nuscenes_gs25600_dynamic_new/render_vis',
            vis_every=500,
        ),
        dict(
            type='DynamicLoss',
            weight=1.0,
            pos_weight=40.0,
            vis_dir='out/nuscenes_gs25600_dynamic_new/dynamic_vis',
            vis_every=500,
        ),
    ])
