...
loss = dict(
    loss_cfgs=[
        ...
        dict(
            ...
            type='MapLoss'),
        dict(depth_lw=0.05, sem_lw=2.0, type='RenderLoss', weight=1.0),
        dict(type='PlanLoss', weight=10.0),
    ],
    type='MultiLoss')
...
model = dict(
    ...
    head=dict(
        ...
        num_classes=18,
        render_config=dict(
            depth_lw=0.05, render_h=256, render_w=704, sem_lw=2.0),
        type='GaussianHead',
        with_empty=True),
...
work_dir = 'out/nuscenes_gs25600_faster'
xyz_coordinate = 'cartesian'
